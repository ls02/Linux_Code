...
inline const std::string& EchoResponse::response() const {
  // @@protoc_insertion_point(field_get:example.EchoResponse.response)
...
void EchoResponse::set_response(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.response_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:example.EchoResponse.response)
}
inline std::string* EchoResponse::mutable_response() {
  std::string* _s = _internal_mutable_response();
  // @@protoc_insertion_point(field_mutable:example.EchoResponse.response)
  return _s;
}
...
inline std::string* EchoResponse::release_response() {
  // @@protoc_insertion_point(field_release:example.EchoResponse.response)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:example.EchoResponse.response)
}
